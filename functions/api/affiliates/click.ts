import { getDb, recordClick, findAffiliateByCode } from '../../_shared/db.js';
import { json, errorResponse, sanitize, getClientIp, getUserAgent, withCors, handleCorsPreflight } from '../../_shared/utils.js';
